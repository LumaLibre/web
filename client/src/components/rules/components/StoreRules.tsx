    ...
    return (
        <>
            <div className={styles.rulesTitleText}>
                <h1 id="store">Store Guidelines</h1>
            </div>
            <div className={styles.rulesBodyText}>
                ...
                <AnchorHeading id="store-personalized-tags">
                ...
                <ul>
                    ...
                    <li>Staff retains the right to reject any tag for any reason and can withdraw permission to a
